...
**Key Achievement:** When a suspicious transaction arrives (new device + impossible travel + high amount), the system flags it as CRITICAL and recommends BLOCK — all in ~30ms.
...
POST /api/v1/score              Score transaction (ML + SHAP)
...
- [x] Phase 3 — Production
  ...
  - [x] DB indexes added
  - [x] End-to-end testing (100 transactions)
...
## 💼 Resume Points
Built end-to-end real-time fraud detection system from scratch
